...
<!DOCTYPE html>
	...
	<body style= "background-image:url('brownbody.png');">
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="background-color: whitesmoke;text-align: center;color: rgb(68, 185, 111)">
				...
				<span style="font-size: 12px;">
					...
					<?php if(i_own_content($user_data)):?>
						...
						<a onclick="show_change_profile_image(event)" style="text-decoration: none;color:rgb(68, 185, 111);" href="change_profile_image.php?change=profile">Change Profile Image</a> | 
						<a onclick="show_change_cover_image(event)" style="text-decoration: none;color:rgb(68, 185, 111);" href="change_profile_image.php?change=cover">Change Cover</a>
				...
				<br>
					...
					<div style="font-size: 20px;color: black;">
						...
						<a href="like.php?type=user&id=<?php echo $user_data['userid'] ?>">
							<input id="post_button" type="button" value="Follow <?php echo $mylikes ?>" style="margin-right:10px;background-color: rgb(68, 185, 111);width:auto;">
						</a>
				...
				<?php 
					if($user_data['userid'] == $_SESSION['mybook_userid']){
						echo '<a href="profile.php?section=setitngs&id='.$user_data['userid'].'"><div id="menu_buttons">Settings</div></a>';
					}
				?>
			</div>
